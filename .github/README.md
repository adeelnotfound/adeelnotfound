...
<!--
  Self-hosted — generated daily by .github/workflows/trophy.yml and committed
  to assets/trophy.svg, instead of hot-linking the shared public instance at
  github-profile-trophy.vercel.app (that endpoint gets rate-limited/paused
  under load — same reason metrics.svg is self-hosted above). Blank until the
